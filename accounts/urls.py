...
from .views import (
    ...
    faculty_student_submissions,
    faculty_grade_submission_view,
    faculty_grade_submission_submit,
    faculty_assignment_detail_view,
    faculty_assignment_detail_ajax,
    faculty_assignment_update,
    student_home,
...
urlpatterns = [
    ...
    path("faculty/student-submissions/<uuid:student_module_id>/<uuid:module_run_id>/", faculty_student_submissions, name="faculty_student_submissions"),
    path("faculty/grade-submission-view/<uuid:assignment_id>/<uuid:submission_id>/", faculty_grade_submission_view, name="faculty_grade_submission_view"),
    path("faculty/grade-submission/<uuid:assignment_id>/<uuid:submission_id>/", faculty_grade_submission_submit, name="faculty_grade_submission_submit"),
    ...
    path("faculty/assignments/<uuid:assignment_id>/update/", faculty_assignment_update, name="faculty_assignment_update"),
